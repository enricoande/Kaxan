...
#define S_FUNCTION_NAME transp_tmat_1dof
...
#define DOF   1  // no. degrees of freedom
#define PHI   3
#define THETA 4
#define PSI   5        
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    // Output the thrust vector in 1 DOF in the body-fixed frame:
    t_bf[0] = R*(*t_if[0]); 
}
